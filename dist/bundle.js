...
(function () {
    var selector = new index_1.default('select');
    var eventsLog = $('#events-log');
    selector.setListener(function (event, data) {
...
var Selector = /** @class */ (function () {
    ...
    Selector.prototype.setListener = function (listener) {
        ...
        Object.keys(events).forEach(function (eventKey) {
            _this.getElement().on(events[eventKey], function (event) {
                var data = [];
                for (var _i = 1; _i < arguments.length; _i++) {
                    data[_i - 1] = arguments[_i];
                }
                return listener(event.type, data);
            });
        });
    };
    /**
